...
const POS = () => {
    ...
    // Mock Data
    const products = [
        { id: 1, name: 'Amoxicillin 250mg', sku: 'AMX-250', price: 12.99, stock: 141, generic: 'Amoxicillin', isRx: true },
        { id: 2, name: 'Paracetamol 500mg', sku: 'PAR-500', price: 5.00, stock: 8, generic: 'Acetaminophen', isRx: false }, // Low stock mock
        { id: 3, name: 'Ibuprofen 400mg', sku: 'IBU-400', price: 8.50, stock: 45, generic: 'Ibuprofen', isRx: false },
        { id: 4, name: 'Cetirizine 10mg', sku: 'CET-10', price: 15.00, stock: 12, generic: 'Cetirizine', isRx: false },
    ];

    const quickActions = ['Pain Relief', 'Cold & Flu', 'First Aid', 'Allergy', 'Vitamins'];
                    ...
                    <div className="w-7/12 flex flex-col border-r border-gray-200 dark:border-slate-700">
                        ...
                        <div className="p-4 border-b border-gray-200 dark:border-slate-700">
                            <div className="relative">
                                <span className="material-symbols-outlined absolute left-3 top-2.5 text-gray-400">person_search</span>
                                <input className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-800 border-none rounded-lg text-sm focus:ring-2 focus:ring-primary placeholder-gray-400 dark:text-white" placeholder="Search customer (Alt+C)..." type="text" />
                        ...
                        <div className="px-5 py-3 flex items-center justify-between bg-gray-50/50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-slate-700">
                            <h3 className="font-semibold text-gray-800 dark:text-gray-200 text-sm">Cart Items <span className="bg-primary/10 text-primary px-2 py-0.5 rounded-full text-xs ml-2">2</span></h3>
                            <div className="flex items-center gap-2">
                                <button className="p-1.5 text-gray-500 hover:text-amber-600 rounded hover:bg-amber-50" title="Hold Cart">
                                    <span className="material-symbols-outlined text-lg">pause_circle</span>
                                </button>
                                <button className="p-1.5 text-gray-500 hover:text-red-600 rounded hover:bg-red-50" title="Clear Cart">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-white dark:bg-gray-900">
                            {/* Example Cart Item 1 */}
                            <div className="flex items-center justify-between p-3 border border-gray-100 dark:border-slate-800 rounded-lg hover:border-primary/30 hover:shadow-sm transition-all group bg-white dark:bg-card-dark">
                                <div className="flex-1">
                                    <div className="flex items-center gap-2">
                                        <span className="font-medium text-gray-800 dark:text-gray-200 text-sm">Amoxicillin 250mg</span>
                                    ...
                                    <div className="text-xs text-gray-400 mt-1 flex items-center gap-2">
                                        <span>AMX-250-001</span>
                                        {/* Prescription Trigger */}
                                        <button 
                                            onClick={() => { setSelectedCartItem({ name: 'Amoxicillin 250mg' }); setActiveModal('prescription'); }}
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="font-medium text-gray-800 dark:text-gray-200 text-sm w-16 text-right">$25.00</div>
                                    <div className="flex items-center border border-gray-200 dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-gray-800 h-8">
                                        <button className="px-2 h-full text-gray-500 hover:text-primary hover:bg-gray-100 dark:hover:bg-gray-700 rounded-l-lg transition-colors"><span className="material-symbols-outlined text-sm">remove</span></button>
                                        <span className="px-2 text-sm font-semibold w-8 text-center text-gray-800 dark:text-gray-200">1</span>
                                        <button className="px-2 h-full text-gray-500 hover:text-primary hover:bg-gray-100 dark:hover:bg-gray-700 rounded-r-lg transition-colors"><span className="material-symbols-outlined text-sm">add</span></button>
                                    </div>
                                    <div className="font-bold text-gray-900 dark:text-white w-16 text-right">$25.00</div>
                                    <button className="text-gray-400 hover:text-red-500 transition-colors"><span className="material-symbols-outlined text-lg">close</span></button>
                                </div>
                            </div>
                             ...
                             <div className="flex items-center justify-between p-3 border border-gray-100 dark:border-slate-800 rounded-lg hover:border-primary/30 hover:shadow-sm transition-all group bg-white dark:bg-card-dark">
                                <div className="flex-1">
                                    <div className="flex items-center gap-2">
                                        <span className="font-medium text-gray-800 dark:text-gray-200 text-sm">Ibuprofen 400mg</span>
                                    </div>
                                    <div className="text-xs text-gray-400 mt-1">IBU-400-002</div>
                                </div>
                                <div className="flex items-center gap-6">
                                    <div className="font-medium text-gray-800 dark:text-gray-200 text-sm w-16 text-right">$12.99</div>
                                    <div className="flex items-center border border-gray-200 dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-gray-800 h-8">
                                        <button className="px-2 h-full text-gray-500 hover:text-primary hover:bg-gray-100 dark:hover:bg-gray-700 rounded-l-lg transition-colors"><span className="material-symbols-outlined text-sm">remove</span></button>
                                        <span className="px-2 text-sm font-semibold w-8 text-center text-gray-800 dark:text-gray-200">1</span>
                                        <button className="px-2 h-full text-gray-500 hover:text-primary hover:bg-gray-100 dark:hover:bg-gray-700 rounded-r-lg transition-colors"><span className="material-symbols-outlined text-sm">add</span></button>
                                    </div>
                                    <div className="font-bold text-gray-900 dark:text-white w-16 text-right">$12.99</div>
                                    <button className="text-gray-400 hover:text-red-500 transition-colors"><span className="material-symbols-outlined text-lg">close</span></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-4 border-t border-gray-200 dark:border-slate-700 bg-white dark:bg-card-dark shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-10">
                            <div className="flex gap-2 mb-4 overflow-x-auto pb-2 scrollbar-hide">
                                {['Cash', 'Card', 'Mobile', 'Insurance'].map(method => (
                                    <button key={method} className="flex-shrink-0 px-4 py-2 border border-gray-200 dark:border-slate-700 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:border-primary hover:text-primary bg-white dark:bg-gray-800 transition-all flex items-center gap-2">
                            ...
                            <div className="flex justify-between items-end mb-4">
                                <div className="text-sm text-gray-500 dark:text-gray-400">
                                    Subtotal: <span className="font-medium text-gray-800 dark:text-gray-200">$37.99</span><br/>
                                    Tax (0%): <span className="font-medium text-gray-800 dark:text-gray-200">$0.00</span>
                                </div>
                                <div className="text-right">
                                    <span className="text-sm text-gray-500 dark:text-gray-400 block mb-1">Total Amount</span>
                                    <span className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">$37.99</span>
                                </div>
                            </div>

                            <button 
                                onClick={() => showToast('Sale completed successfully!')}
                                className="w-full py-3.5 bg-primary hover:bg-primary-hover text-white rounded-xl font-bold shadow-lg shadow-blue-500/20 active:scale-[0.99] transition-all flex items-center justify-center gap-2"
                            >
                    ...
                    <div className="w-5/12 flex flex-col bg-gray-50 dark:bg-gray-900/50">
                        ...
                        <div className="p-4 bg-white dark:bg-card-dark border-b border-gray-200 dark:border-slate-700 shadow-sm z-10">
                            <div className="relative mb-3">
                                ...
                                <input className="w-full pl-10 pr-4 py-2.5 bg-gray-100 dark:bg-gray-800 border-transparent focus:bg-white dark:focus:bg-gray-900 border focus:border-primary rounded-lg text-sm transition-all outline-none dark:text-white" placeholder="Scan barcode or search products..." />
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                                    {quickActions.map(action => (
                                        <button key={action} className="flex-shrink-0 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-300 text-xs font-medium rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors border border-blue-100 dark:border-blue-900/50">
                                            {action}
                                        </button>
                                    ))}
                                </div>
                                ...
                                {products.map(product => (
                                    <div 
                                        ...
                                        className={`
                                            ...
                                            ${product.stock < 10 ? 'border-red-200 dark:border-red-900/50' : 'border-gray-200 dark:border-slate-700 hover:border-primary dark:hover:border-primary'}
                                        `}
                                    >
                                        ...
                                        <div className="absolute inset-0 bg-primary/95 text-white p-4 flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-center z-10 pointer-events-none">
                                            ...
                                            <p className="font-bold text-sm">{product.generic}</p>
                                        </div>

                                        <div className="flex justify-between items-start mb-2">
                                            <h4 className="font-semibold text-gray-800 dark:text-gray-200 text-sm leading-tight pr-2">{product.name}</h4>
                                            {product.isRx && (
                                        ...
                                        <div className="flex flex-col gap-1 mb-3">
                                            ...
                                            {product.stock < 10 ? (
                                                <div className="inline-flex items-center gap-1 text-[10px] font-bold text-red-500 bg-red-50 dark:bg-red-900/20 px-1.5 py-0.5 rounded w-fit">
                                                    <span className="material-symbols-outlined text-[10px]">warning</span> Low Stock: {product.stock}
                                                </div>
                                            ) : (
                                                <span className="text-[10px] text-gray-500 bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded w-fit">Stock: {product.stock}</span>
                                            )}
                                        </div>
            ...
            {activeModal === 'shift' && (
                <ModalOverlay title="Open Register Shift" onClose={() => setActiveModal(null)}>
                     <div className="space-y-4">
                        ...
                        <div className="pt-4">
                             <button 
                                onClick={() => { setActiveModal(null); setShiftActive(true); showToast('Shift Opened Successfully'); }} 
